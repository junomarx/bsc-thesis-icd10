...
Escape to leave it at any time.
...
\begin{itemize}
  ...
  \item The selected language and the fact that the first-visit tutorial
        has been dismissed are stored locally in the browser so those two
        interface preferences survive a reload. Neither value contains a
        learner response or is sent to the server.
