...
six-patient/25-question model described in this guide: 77 unit tests, 160
integration tests (against a live MySQL baseline), and 9 browser-driven
end-to-end tests, all passing as of the last verified run (see
