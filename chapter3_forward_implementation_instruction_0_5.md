...
9. `prototype_baseline_0_2_design/README.md` and its versioned runtime/verification data.
...
5. Replace/extend case-centric API contracts with patient/question endpoints while retaining a non-learner path to hidden regression questions.
